...
use registry_canister::{
    ...
    mutations::{
        ...
        do_update_super_users::{UpdateSuperUsersPayload, UpdateSuperUsersResult},
...
#[unsafe(export_name = "canister_update update_super_users")]
fn update_super_users() {
    check_caller_is_subnet_rental_canister_and_log("update_super_users");
    over(candid_one, |payload: UpdateSuperUsersPayload| {
        update_super_users_(payload)
    });
}

#[candid_method(update, rename = "update_super_users")]
fn update_super_users_(payload: UpdateSuperUsersPayload) -> UpdateSuperUsersResult {
    let result = registry_mut().do_update_super_users(payload);
    recertify_registry();
    result
}
